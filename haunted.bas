...
820 IF RM=54 AND C(15)<>1 THEN M$="YOU ARE STUCK!":RETURN
...
1170 RETURN
1180 M$="OK '"+W$+"'"
1190 IF C(3)=1 AND OB=34 THEN M$="*MAGIC OCCURS*":IF RM<>45 THEN LET RM=RND(63)
...
1280 IF OB=13 AND C(13)=1 AND RM=43 THEN R$(RM)="WN":D$(RM)="STUDY WITH SECRET ROOM":M$="YOU BROKE THE THINK WALL"
1290 RETURN
...
1360 IF OB=17 AND C(17)=1 AND C(9)=1 AND C(8)=1 THEN M4="IT CASTS A FLICKERING LIGHT":F(0)=1
1370 RETURN
1380 IF F(0)=1 THEN F(0)=0:M$="EXINGUISHED"
1390 RETURN
...
1760 DATA NE,NW,NW,W,NSE,WE,W,NS
